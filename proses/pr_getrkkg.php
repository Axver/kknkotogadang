<?php
	...
	$sql = "select ST_asgeojson(geom) AS geometry, test.gid,test.status,pemilik.nama,pemilik.suku,pemilik.nama_datuk,pemilik.tgl_lahir,pemilik.pendidikan  FROM test LEFT JOIN pemilik ON test.gid=pemilik.gid;";
	$result = pg_query($sql);
	$hasil2 = array(
